<template>
  <div class="card shadow-none m-0">
    <div class="card-body p-0 ">
      ...
      <div class="p-2">
        <div v-if="recent_messages.length === 0" class="container">
          <h6>Caixa de mensagens vazia</h6>
        </div>
      ...
      <router-link to="/mensagens" class="right-ic btn-block position-relative p-3 border-top text-center"
        role="button">Ver tudo</router-link>
    </div>
  </div>
</template>
