          ...
          <div class="col-lg-12">
            <div class="card card-block card-stretch card-height">
              <div class="card-header d-flex justify-content-between">
                ...
                <a href="#" class="btn btn-primary" data-toggle="modal" data-target="#addSwitcher">Adicionar
                  Switcher</a>
              </div>
              <div class="card-body">
                      ...
                      <tr v-for="switcher in switchers" :key="switcher.id">
                        ...
                        <td>
                          <div class="d-flex align-items-center list-action justify-content-end">
                            ...
                            <div class="badge bg-primary-light" data-toggle="tooltip" data-placement="top" title=""
                              data-original-title="Action">
                              <div class="dropdown">
                                <div class="text-primary dropdown-toggle action-item" id="moreOptions1"
                                  data-toggle="dropdown" aria-haspopup="true" role="button" aria-expanded="false"></div>
                                <div class="dropdown-menu" aria-labelledby="moreOptions1">
                                  <a class="dropdown-item" href="#" data-toggle="modal" data-target="#updateSwitcher"
                                    @click="loadSwitcher(switcher)">Editar</a>
                                  <a class="dropdown-item" href="#"
                                    @click="deleteSwitcher(switcher.id, switcher.name)">Excluir</a>
                                </div>
                              </div>
                            </div>
                          </div>
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="name" v-model="switcher.name" placeholder="Nome"
                        required="true" />
                    </div>
                  </div>
                </div>
...
<script lang="ts">
import { optionsTable } from '../assets/images/js/datatable';
