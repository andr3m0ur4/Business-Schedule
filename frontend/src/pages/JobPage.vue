                            ...
                            <div class="badge bg-primary-light" data-toggle="tooltip" data-placement="top" title=""
                              ...
                              <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="moreOptions1">
                                  <a class="dropdown-item" href="#" data-toggle="modal" data-target="#updateJob"
                                    @click="loadJob(job)">Editar</a>
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="name" v-model="job.name" placeholder="Nome"
                        required="true" />
                    </div>
                  </div>
                </div>
...
export default defineComponent({
  ...
  setup() {
    ...
    const swal = inject('$swal') as (arg1: string|object, arg2?: string, arg3?: string) => any;
