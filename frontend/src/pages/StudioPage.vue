                            ...
                            <div class="badge bg-primary-light" data-toggle="tooltip" data-placement="top" title=""
                              ...
                              <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="moreOptions1">
                                  <a class="dropdown-item" href="#" data-toggle="modal" data-target="#updateStudio"
                                    @click="loadStudio(studio)">Editar</a>
                                  <a class="dropdown-item" href="#"
                                    @click="deleteStudio(studio.id, studio.name)">Excluir</a>
                                </div>
                              </div>
                            </div>
                          </div>
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="name" v-model="studio.name" placeholder="Nome"
                        required="true" />
                    </div>
                  </div>
                </div>
...
<script lang="ts">
import IStudio from '../interfaces/IStudio';
