                            ...
                            <div class="badge bg-primary-light" data-toggle="tooltip" data-placement="top" title=""
                              ...
                              <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="moreOptions1">
                                  <a class="dropdown-item" href="#" data-toggle="modal" data-target="#updateTvshow"
                                    @click="loadTvshow(tvshow)">Editar</a>
                                  <a class="dropdown-item" href="#"
                                    @click="deleteTvshow(tvshow.id, tvshow.name)">Excluir</a>
                                </div>
                              </div>
                            </div>
                          </div>
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="name" v-model="tvshow.name" placeholder="Nome"
                        required="true" />
                    </div>
                  </div>
                </div>
