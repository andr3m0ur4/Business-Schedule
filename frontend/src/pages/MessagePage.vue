                            ...
                            <div class="card-body">
                              <div class="d-flex flex-wrap align-items-center justify-content-between">
                                ...
                                <a href="#" class="btn btn-primary" data-toggle="modal" data-target="#addChat"
                                  @click="messageInfo.user_id_to = employee.id; messageInfo.user_id_from = messageT.user_id_from">Enviar
                                  mensagem</a>
                              </div>
                            </div>
                          </div>
      ...
      <ModalChat :id="'addChat'" @onHide="clearMessage">
        ...
        <template v-slot:body>
          <div class="col-12 border rounded">
            <div id="box-message" class="scrollspy-example" data-spy="scroll" data-target="#navbar-example2"
              data-offset="0">
...
import { GET_MESSAGES, GET_USERS_MESSAGES, INSERT_MESSAGE } from '../store/action-types';
...
export default defineComponent({
  ...
  methods: {
    saveMessage() {
      ...
      store.state.message.messages.forEach((item) => {
