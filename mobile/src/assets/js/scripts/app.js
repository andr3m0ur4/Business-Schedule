...
import { generateRandomEvents, MOCK_CALENDARS } from "./mock-data";
...
function initCalendar() {
  ...
  // Elements
  var navbarRange = $('#renderRange');
  var prevButton = $('.prev');
  var nextButton = $('.next');
  var todayButton = $('.today');
  var dropdown = $('.dropdown');
  var dropdownTrigger = $('.bootstrap-select');
  var dropdownTriggerIcon = $('#dropdownMenu-calendarType');
  var dropdownContent = $('.dropdown-menu');
  var checkboxCollapse = $('.checkbox-collapse');
  var sidebar = $('.lnb-calendars');
