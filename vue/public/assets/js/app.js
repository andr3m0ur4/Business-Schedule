    ...
    calendar1 = new FullCalendar.Calendar(calendarEl, {
        ...
        events: [
            ...
            },
            {
                ...
                start: moment(new Date(), 'YYYY-MM-DD').add(51, 'days').format('YYYY-MM-DD') + 'T05:30:00.000Z',
                color: '#465af7'
            }
        ]
    });
...
function submitCalendar() {
    document.querySelector('#submit-schedule').onsubmit = function (e) {
        e.preventDefault()
