      ...
      <div class="row">
          <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="card card-block card-stretch card-height">
              <div class="card-body text-center">
                ...
                <h2 class="mb-2 mt-3 text-primary">00:00:00</h2>
                <h4>Tempo restante até persistir nova escala</h4>
              </div>
            </div>
          </div>
        ...
        <div class="col-lg-4 col-md-4">
          <div class="card card-block card-stretch card-height">
            ...
            <div class="card-body text-center">
              ...
              <h2 class="mb-2 mt-3 text-primary">100+</h2>
              <h4>Visualizadores da escala atual</h4>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-4 col-md-4">
          <div class="card card-block card-stretch card-height">
            <div class="card-header">
              <div class="header-title">
                <h4 class="card-title">Limite de horas trabalhadas</h4>
              </div>
            </div>
            <div class="card-body">
